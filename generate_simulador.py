...
simulador_content = """import { useMemo, useState } from "react";
...
with open('src/pages/Simulador.tsx', 'w') as f:
    f.write(simulador_content)

os.unlink('src/pages/Simulacion.tsx')
