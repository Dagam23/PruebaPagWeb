...
with open('src/pages/Monitoreo.tsx', 'r') as f:
    content = f.read()
...
sensors_str_start = "  const sensors = ["
sensors_str_end = "];"
# find the block
idx_start = content.find(sensors_str_start)
idx_end = content.find("  const filteredSensors = ", idx_start)
